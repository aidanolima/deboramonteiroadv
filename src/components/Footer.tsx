...
export default function Footer() {
  ...
  return (
    // VISUAL CLEAN: Mudança para bg-zinc-800 e bordas mais suaves
    <footer id="footer" className="relative bg-zinc-800 text-zinc-300 py-8 px-6 text-sm border-t border-zinc-700 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* AJUSTE DE GRADIENTE: Tons mais claros (zinc-800) e mais transparentes */}
        <div className="absolute inset-0 bg-gradient-to-t from-amber-500/5 via-transparent to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-zinc-800/95 via-zinc-800/80 to-zinc-800/60"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8 px-6">
        ...
        <div className="flex-1">
          ...
          <p className="mb-1 text-base font-medium text-zinc-200">Advocacia e Consultoria Jurídica</p>
          <p className="text-amber-500 font-semibold text-lg">OAB/MT 24567/O</p>
        </div>
        ...
        <div className="flex-1 md:text-right flex flex-col items-start md:items-end gap-3">
          ...
          <p className="flex items-center gap-2 group">
            ...
            <a href="mailto:deb_monteiro@hotmail.com" className='text-zinc-200 hover:text-white transition-colors'>deb_monteiro@hotmail.com</a>
          </p>
          ...
          <p className="flex items-center gap-2 group">
            ...
            <a href="https://instagram.com/deboramonteiroadv" target="_blank" rel="noopener noreferrer" className='text-zinc-200 hover:text-white transition-colors'>
              @deboramonteiroadv
            </a>
          </p>
          ...
          <p className="flex items-center gap-2 group">
            ...
            <span className='text-zinc-200'>(65) 99113-3336</span>
          </p>
          
          <p className="flex items-center gap-2 group">
            <svg className="w-5 h-5 text-amber-500 group-hover:text-amber-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            <span className='text-zinc-200'>Cuiabá - MT</span>
          </p>
        </div>
      ...
      {/* BARRA FINAL */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 mt-8 pt-6 border-t border-zinc-700 text-center md:text-left flex flex-col md:flex-row justify-between text-zinc-400">
        <p>
          &copy; {currentYear}{" "}
          <a 
